                                ...
                                <form action="{{ route('donation.payment-selection') }}" method="GET">
                                    ...
                                    <div class="flex flex-col lg:flex-row items-center justify-center gap-4 sm:gap-6 lg:gap-4 xl:gap-8">
                                        ...
                                        <div class="flex items-center gap-2 sm:gap-4">
                                            ...
                                            <label class="text-xl sm:text-2xl md:text-3xl lg:text-3xl xl:text-4xl text-white font-bold whitespace-nowrap">Chci přispět:</label>
                                        </div>
                                        ...
                                        <div class="flex items-center gap-2 sm:gap-3">
                                            <!-- Stripe Badge (Color inverted to match dark bg) -->
                                            <div class="bg-white rounded h-9 sm:h-11 px-3 flex items-center justify-center">
                                                <svg class="h-5 sm:h-6 w-auto" viewBox="0 0 60 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="bg-white rounded h-9 sm:h-11 px-2 flex items-center justify-center">
                                                <img src="{{ asset('visa.png') }}" alt="Visa" class="h-6 sm:h-8 w-auto">
                                            </div>
