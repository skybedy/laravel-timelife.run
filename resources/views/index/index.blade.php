                        ...
                        <div class="bg-gray-700 sm:rounded-2xl overflow-hidden">
                            ...
                            <div class="text-white text-center font-black bg-gray-700 px-6 py-8">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                    ...
                                    <div class="col-span-1 md:col-span-2 lg:col-span-3 bg-transparent border-2 border-white rounded-xl px-8 py-6">
                                        <form action="{{ route('registration.checkout.dynamic') }}" method="POST" class="w-full">
                                            ...
                                            <div class="flex flex-wrap items-center justify-center gap-6 lg:gap-8">
                                                ...
                                                <div class="flex items-center gap-4">
                                                    <svg class="w-10 h-10 lg:w-12 lg:h-12 text-white flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"></path>
                                                    </svg>
                                                    <label class="text-2xl sm:text-3xl md:text-4xl text-white font-bold whitespace-nowrap">Podpořit:</label>
                                                </div>
                                                ...
                                                <input
                                                    ...
                                                    required
                                                    class="w-64 lg:w-80 px-8 py-4 rounded-lg text-gray-900 font-bold text-2xl focus:outline-none focus:ring-2 focus:ring-white"
                                                >

                                                <!-- via Stripe -->
                                                <div class="flex items-center gap-4">
                                                    <span class="text-white text-lg lg:text-xl">via</span>
                                                    <svg class="h-10 lg:h-12" viewBox="0 0 60 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <button
                                                    type="submit"
                                                    class="bg-white text-gray-500 font-bold rounded-lg hover:bg-gray-100 transition-colors text-2xl whitespace-nowrap"
